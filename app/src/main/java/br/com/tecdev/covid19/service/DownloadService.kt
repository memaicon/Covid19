package br.com.tecdev.covid19.service
...
import br.com.tecdev.covid19.firebase.fcm.CovidMessagingService
import java.io.File
...
class DownloadService : Service() {
    ...
    private fun showNotificationDownload() {
        ...
        notificationBuilder =
            NotificationCompat.Builder(applicationContext, CovidMessagingService.CHANNEL_ID_UPDATE)
                ...
                .setColor(ContextCompat.getColor(applicationContext, R.color.purpleAccent))
                .setOngoing(true)
    ...
    companion object {
        private const val FILE_NAME = "Covid19Update.apk"
