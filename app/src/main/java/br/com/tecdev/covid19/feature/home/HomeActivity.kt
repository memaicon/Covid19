...
import br.com.tecdev.covid19.dialog.MessageDialog
import br.com.tecdev.covid19.feature.credits.CreditsActivity
import br.com.tecdev.covid19.feature.emergency.EmergencyActivity
import br.com.tecdev.covid19.feature.feedback.FeedbackActivity
import br.com.tecdev.covid19.feature.global.GlobalCasesActivity
import br.com.tecdev.covid19.feature.search.SearchActivity
import br.com.tecdev.covid19.feature.symptoms.SymptomsActivity
...
import br.com.tecdev.covid19.util.changeBitmap
import br.com.tecdev.covid19.service.DownloadService
import br.com.tecdev.covid19.util.formatNumber
import br.com.tecdev.covid19.util.location.SmartLocation
import br.com.tecdev.covid19.util.setTransparentStatusBar
...
class HomeActivity : AppCompatActivity(), OnMapReadyCallback {
    ...
    private fun sendEmail() {
        ...
        emailIntent.putExtra(Intent.EXTRA_EMAIL, arrayOf("maicon.esperafico@rede.ulbra.br"))
        emailIntent.putExtra(Intent.EXTRA_SUBJECT, "Covid19 App")
        emailIntent.putExtra(Intent.EXTRA_TEXT, "Olá, gostaria de mais informações!")
